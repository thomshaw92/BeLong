...
#H&N
cp sub-016_ses-01_run-01_echo-01_part-phase_MEGRE_scaled_qsm_000_twopass_average.nii ${SCT_dir}/sub-016/ses-01/qsm/qsmH.nii
#n
...
#no neck for 6
#head good
cp sub-007/ses-1/anat/*E01_run-1_magnitude.nii.gz ${SCT_dir}/sub-007/ses-01/qsm/qsmHM.nii.gz
#neck
cp sub-007/ses-10/anat/*E01_run-1_magnitude.nii.gz ${SCT_dir}/sub-007/ses-01/qsm/qsmNM.nii.gz
#h&n   - bad 
cp sub-011/ses-01/anat/sub-011_ses-01_run-02_echo-01_part-mag_MEGRE.nii ${SCT_dir}/sub-011/ses-01/qsm/qsmHM.nii
#no neck for 11
#H&N
cp sub-013/ses-01/anat/sub-013_ses-01_run-02_echo-01_part-mag_MEGRE.nii ${SCT_dir}/sub-013/ses-01/qsm/qsmHM.nii
#N
cp sub-013/ses-01/anat/sub-013_ses-01_run-04_echo-01_part-mag_MEGRE.nii ${SCT_dir}/sub-013/ses-01/qsm/qsmNM.nii
#H&N
cp sub-014/ses-01/anat/sub-014_ses-01_run-02_echo-01_part-mag_MEGRE.nii ${SCT_dir}/sub-014/ses-01/qsm/qsmHM.nii
#N
cp sub-014/ses-01/anat/*_run-04_echo-01_part-mag_MEGRE.nii ${SCT_dir}/sub-014/ses-01/qsm/qsmNM.nii
#H&N
cp sub-015/ses-01/anat/*_run-02_echo-01_part-mag_MEGRE.nii ${SCT_dir}/sub-015/ses-01/qsm/qsmHM.nii
#N 
...
#N
cp sub-017/ses-01/anat/*_run-08_echo-01_part-mag_MEGRE.nii ${SCT_dir}/sub-017/ses-01/qsm/qsmNM.nii
#H&N
cp sub-018/ses-01/anat/*_run-02_echo-01_part-mag_MEGRE.nii ${SCT_dir}/sub-018/ses-01/qsm/qsmHM.nii
#N
cp sub-018/ses-01/anat/*_run-08_echo-01_part-mag_MEGRE.nii ${SCT_dir}/sub-018/ses-01/qsm/qsmNM.nii
#HN
cp sub-019/ses-01/anat/*_run-02_echo-01_part-mag_MEGRE.nii ${SCT_dir}/sub-019/ses-01/qsm/qsmHM.nii
#N
cp sub-019/ses-01/anat/*_run-04_echo-01_part-mag_MEGRE.nii ${SCT_dir}/sub-019/ses-01/qsm/qsmNM.nii
#HN #THIS IS WRONG but i cant find the right one
cp sub-021/ses-01/anat/*_run-02_echo-01_part-mag_MEGRE.nii ${SCT_dir}/sub-021/ses-01/qsm/qs
cp sub-021/ses-01/anat/*_run-06_echo-01_part-mag_MEGRE.nii ${SCT_dir}/sub-021/ses-01/qsm/qsmHM.nii
#all the same
for x in sub-020 sub-022 sub-023 sub-024 sub-025 sub-026 sub-027 sub-028 sub-029 ; do 
    cp ${x}/ses-0?/anat/${x}_ses*_run-02_echo-01_part-mag_MEGRE.nii ${SCT_dir}/${x}/ses-01/qsm/qsmHM.nii
    cp ${x}/ses-0?/anat/${x}_ses*_run-04_echo-01_part-mag_MEGRE.nii ${SCT_dir}/${x}/ses-01/qsm/qsmNM.nii
done

for subjName in 011 013 014 015 016 017 018 019 020 021 022 023 024 025 026 027 028 029 ; do    
...
for subjName in 005 006 007 ; do    
    cd  ${SCT_dir}/sub-${subjName}/ses-01/qsm/
    for x in *nii ; do
	gzip $x
    done
