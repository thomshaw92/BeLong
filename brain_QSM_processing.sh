...
${singularity}/run_0_dicomSort.py ${raw_data_dir}/${subjName} ${out_dir}/00_dicom
...
#2. Run QSM pipeline:
${singularity}/run_2_qsm.py ${out_dir}/01_bids ${out_dir}/02_qsm_output --add_bet --homogeneity_filter --threshold 20 
